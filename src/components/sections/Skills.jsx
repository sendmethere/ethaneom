      ...
      <div className="container-base">
        ...
        <div>
          ...
          <div className="relative -mx-6 md:-mx-12">
            {/* scroll track */}
            <div className="flex gap-4 overflow-x-auto pb-4 px-6 md:px-12 snap-x snap-mandatory
                            [&::-webkit-scrollbar]:h-1.5
                            [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-bg-deep
